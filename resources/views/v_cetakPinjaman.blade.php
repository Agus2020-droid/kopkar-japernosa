        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <th><p class="text-center">KODE</th>
              ...
              <th><p class="text-center">Tenor</th>
              <th><p class="text-center">Plafon</th>
            </tr>
            </thead>
            <tbody>
            <?php $no=1; ?>
            <tr>
              ...
              <th><p class="text-center">P-{{$item->no_pinjaman}}</th>
              ...
              <td><p class="text-center">{{$item->tenor}} bln</td>
              <td><p class="text-center">{{format_uang($item->plafon)}}</td>
            </tr>
            </tbody>
          </table>
        </div>
