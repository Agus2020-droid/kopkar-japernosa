...
<form class="form-horizontal" action="/pinjamKetua/update/{{$data->no_pinjaman}}" method="post" enctype="multipart/form-data">
   @csrf
      
        <div class="col-md-12">
          <div class="box box-primary">
          <div class="box-header with-border bg-blue color-palette">
          <h3 class="box-title">FORMULIR APPROVAL PINJAMAN (KETUA)</h3>
        ...
        <!-- /.col -->
            ...
            <div class="row">
                <div class="col-md-2">
                  <label>APPROVAL KETUA</label>
                </div>
                
                <div class="col-md-10">
                <select name="ttd_ketua" type="text" class="form-control select2 select2-accessible" style="width: 100%;" data-select2-id="3" tabindex="-1" aria-hidden="true" id="status" value="{{$data->ttd_ketua}}">
