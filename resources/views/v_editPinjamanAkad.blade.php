...
<section class="content-header">
      <h1>EDIT PINJAMAN AKAD 
      <small>Form</small></h1>
      <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="/pinjam">Pinjaman Anggota</a></li>
        <li class="active">Edit Pinjaman Akad</a></li>
      </ol>
    </section>
<!-- /.pembatas -->
...
@if (count($errors) > 0)
    ...
    @endif
<form class="form-horizontal" action="/pinjam/updateAkad/{{$data->no_pinjaman}}" method="post" enctype="multipart/form-data">
   @csrf
      
        <div class="col-md-12">
          <div class="box box-primary">
          <div class="box-header with-border bg-blue color-palette">
          <h3 class="box-title">FORMULIR EDIT PINJAMAN AKAD</h3>
        ...
        <!-- /.col -->
            ...
            <table id="example2" class="table table-bordered table-hover dataTable">
              ...
              <tr>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10">
                            <select name="jenis_pinjaman" type="text" class="form-control select2 select2-accessible" style="width: 100%;" data-select2-id="2" tabindex="-1" aria-hidden="true">
                                <option value="{{$data->jenis_pinjaman}}">{{$data->jenis_pinjaman}} (Current)</option>
                          ...
                          <div class="row">
                            ...
                            <select name="tenor" type="text" class="form-control select2 select2-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" id="tenor" value="{{$data->tenor}}">
                                <option value="{{$data->tenor}}">{{$data->tenor}} Bulan (default)</option>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10">
                              <input id="bunga" name="bunga" type="text" class="form-control" value="{{$data->bunga}}">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-2">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10">
                            <select name="posisi" type="text" class="form-control select2 select2-accessible" style="width: 100%;" data-select2-id="3" tabindex="-1" aria-hidden="true">
            ...
            <div class="col-md-12">
              <br>
              <a href="/pinjam" class="btn btn-default pull-left">CANCEL</a>
