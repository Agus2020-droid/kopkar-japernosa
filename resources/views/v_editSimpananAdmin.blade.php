        ...
        <!-- /.col -->
          <div class="col-md-9">
            <input name="nik_ktp" type="hidden" value="{{$data->nik_ktp}}">
                ...
                <div class="form-group">
                  <label for="inputName" class="col-sm-3 control-label">Tanggal Pengajuan</label>

                  <div class="col-sm-9">
                    <input name="tgl_pengajuan" type="text" class="form-control"  value="{{Carbon\Carbon::parse($data->tgl_simpanan)->format("d M Y")}}" readonly>
                  </div>
                </div>
                <div class="form-group">
