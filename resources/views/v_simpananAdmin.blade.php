      ...
      <div class="box">
            <div class="box-header bg-blue-active color-palette">
              <div class="pull-left">
                ...
                <a href="{{ route('exportsimpanan')}}" class="btn btn-default btn-sm hint--top" aria-label="Download"><i class="fa fa-download"></i></a>
                <a href="#" class="btn btn-warning btn-sm hint--top" aria-label="Upload File" data-toggle="modal" data-target="#modal-info"><i class="fa fa-download"></i></a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-header">
              ...
              @if (session('pesan'))
                ...
                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                  ...
                  <tr>
                  <td >{{$no++}}</td>
                  <td >S-{{$sim->id_simpanan}}</td>
                  <td>{{$sim->nama}}<br><small class="text-red">{{$sim->nik_ktp}}</small></td>
                  <td >{{$sim->tgl_potongan}}</td>
                  ...
                  <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="/simpananAdmin/delete/{{$sim->id_simpanan}}" class="btn btn-outline">Hapus</a>
                      </div>
                    </div>
                  </div>
                </div>
