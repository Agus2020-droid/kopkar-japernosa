          ...
          <!-- <div class="alert alert-warning alert-dismissible">
            ...
            <div class="text-left">
              <div class="form-inline">
                ...
                <form action="{{route('v_pinjamHrbp')}}" method="post">
                @csrf
                ...
                <a href="/pinjamHrbp" type="button" name="refresh" id="refresh" class="btn btn-success tn-sm hint--top" aria-label="Refresh"><i class="fa fa-refresh"></i></a>
