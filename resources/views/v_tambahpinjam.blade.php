...
@section('content')
  ...
  <div class="row">
      ...
      <form class="form-horizontal" action="{{url('pinjamanSaya/insert')}}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
            ...
            <div class="col-md-12"> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="nik_ktp" class="form-control"  value="{{$item->nik_ktp}}" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="nama" type="text" class="form-control " id="nm_box" value="{{$item->nama}}" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="nik_karyawan" type="text" class="form-control" id="nik_box" value="{{$item->nik_karyawan}}" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="jabatan" type="text" class="form-control "  value="{{$item->jabatan}}" readonly>
                  </div>
                  @endforeach
                </div>
