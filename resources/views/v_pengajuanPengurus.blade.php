          ...
          <div class="box">
            ...
            <div class="text-left">
              <div class="form-inline">
                ...
                <form action="{{route('v_pengajuanPengurus')}}" method="post">
                @csrf
                ...
                <a href="/pengajuanPengurus" type="button" name="refresh" id="refresh" class="btn btn-success tn-sm hint--top" aria-label="Refresh"><i class="fa fa-refresh"></i></a>
              </form>
              </div>
              </div>
              </div>
          ...
          <div class="box-body table-responsive no-padding">              
              ...
              <tr>
               ...
               @foreach($pinjaman as $key => $data )
                ...
                <td >
                <a  href="/pinjamanSaya/detail/{{$data->no_pinjaman}}" class="btn btn-primary btn-sm hint--top" aria-label="Detail"><i class="fa fa-eye"></i></a>
              </td>
                  </td>
                </tr>
              @endforeach
